...
<head>
    ...
    <title>Quản lý loại phòng - RentEz Admin</title>
...
<body class="bg-gradient-to-br from-gray-50 to-gray-100 min-h-screen">
            ...
            <header class="bg-white shadow-sm border-b border-gray-200">
                <div class="px-6 py-4">
                    <div class="flex items-center justify-between">
                        <h2 class="text-2xl font-bold text-gray-800">Quản lý loại phòng</h2>
            ...
            <main class="p-6">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div>
                            ...
                            <div class="relative">
                                <input type="text" id="searchInput" placeholder="Tên loại phòng..."
                                    ...
                                    <tr class="hover:bg-gray-50 transition-colors">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center">
                                                ...
                                                <div class="text-sm font-medium text-gray-900">${propertyType.typeName}</div>
                                            </div>
                                        </td>
                                        <td class="px-6 py-4">
                                            <div class="text-sm text-gray-900 max-w-xs truncate">${propertyType.description}</div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span class="px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full
                                                ${propertyType.status == 'true' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}">
                                                ${propertyType.status == 'true' ? 'Hoạt động' : 'Không hoạt động'}
                                            </span>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <div class="flex space-x-2">
                                                <button onclick="openEditModal('${propertyType.typeId}')" 
                ...
                <div class="mt-6 flex items-center justify-between">
                    <div class="text-sm text-gray-700">
                        ...
                        của <span class="font-medium">${totalPropertyTypes}</span> kết quả
                    </div>
                    <div class="flex space-x-2">
    ...
    <div id="propertyTypeModal" class="fixed inset-0 bg-black bg-opacity-50 hidden overflow-y-auto h-full w-full z-50">
        <div class="relative top-20 mx-auto p-5 border w-[500px] shadow-lg rounded-xl bg-white">
            <div class="mt-3">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="text-lg font-semibold text-gray-900" id="modalTitle">Tạo loại phòng mới</h3>
                    <button onclick="closePropertyTypeModal()" class="text-gray-400 hover:text-gray-600">
                        <i class="fas fa-times text-xl"></i>
                    </button>
                </div>
                
                <form method="post" action="${pageContext.request.contextPath}/admin/property-type-action" id="propertyTypeForm">
                    <input type="hidden" name="action" value="create" id="formAction">
                    <input type="hidden" name="typeId" id="typeId">
                    
                    <div class="mb-4">
                        <label for="typeName" class="block text-sm font-medium text-gray-700 mb-2">Tên loại phòng</label>
                        <input type="text" id="typeName" name="typeName" required 
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500"
                               placeholder="Ví dụ: Căn hộ, Nhà trọ, Biệt thự...">
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="description" name="description" rows="4" 
                                  class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500"
                                  placeholder="Mô tả chi tiết về loại phòng này..."></textarea>
                    </div>
                    
                    <div class="flex justify-end space-x-3">
                        <button type="button" onclick="closePropertyTypeModal()" 
        ...
        <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-xl bg-white">
            <div class="mt-3 text-center">
                ...
                <div class="flex justify-center space-x-3">
                    ...
                    <form method="post" action="${pageContext.request.contextPath}/admin/property-type-action" class="inline">
    ...
    <script>
        function openCreateModal() {
            ...
            document.getElementById('propertyTypeModal').classList.remove('hidden');
        }
        ...
        function openEditModal(typeId) {
            ...
            const formInputs = document.querySelectorAll('#propertyTypeForm input:not([type="hidden"]), #propertyTypeForm select, #propertyTypeForm textarea');
            ...
            // Fetch property type data từ server
            fetch('${pageContext.request.contextPath}/admin/property-types?action=get&typeId=' + typeId)
                .then(response => {
                    if (!response.ok) {
                ...
                .catch(error => {
                    ...
                    alert('Có lỗi khi tải thông tin loại phòng. Vui lòng thử lại.');
                    closePropertyTypeModal();
                });
        }
        
        function closePropertyTypeModal() {
            document.getElementById('propertyTypeModal').classList.add('hidden');
        }
        ...
        window.onclick = function(event) {
            ...
            if (event.target === propertyTypeModal) {
                closePropertyTypeModal();
            }
