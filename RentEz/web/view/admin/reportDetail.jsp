            ...
            <div class="ml-64 flex-1">
                    ...
                    <div class="px-6 py-4">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-4">
                                <a href="${pageContext.request.contextPath}/ReportServlet?action=getUserReports" class="flex items-center gap-2 text-gray-600 hover:text-primary-600 transition-colors">
                                    <i class="fas fa-arrow-left"></i>
                                    <span class="text-sm font-medium">Quay lại</span>
                                </a>
                                <div class="w-px h-6 bg-gray-300"></div>
                                <h2 class="text-2xl font-bold text-gray-800">Chi tiết báo cáo</h2>
                            </div>
                ...
                <main class="p-6">
                    <div class="max-w-2xl mx-auto bg-white rounded-lg shadow p-8">
                        ...
                        <c:choose>
                            <c:when test="${report.isApproved}">
                                <!-- Already Approved Status -->
                                <div class="flex items-center justify-center gap-2 p-4 bg-green-50 border border-green-200 rounded-lg">
                                    <i class="fas fa-check-circle text-green-600 text-xl"></i>
                                    <span class="text-green-800 font-semibold">Tố cáo này đã được xử lý</span>
                                </div>
                            </c:when>
                            <c:otherwise>
                                ...
                                <div class="flex gap-4 justify-end">
                                    <form action="ReportServlet" method="post">
                                        ...
                                        <button type="submit" class="px-5 py-2 rounded bg-green-600 text-white font-semibold hover:bg-green-700 transition flex items-center gap-2">
                                    ...
                                    <form action="ReportServlet" method="post" onsubmit="return confirm('Bạn chắc chắn muốn xóa tố cáo này?');">
                                        ...
                                        <button type="submit" class="px-5 py-2 rounded bg-red-600 text-white font-semibold hover:bg-red-700 transition flex items-center gap-2">
