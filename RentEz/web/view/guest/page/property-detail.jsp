                                ...
                                <div class="landlord-info d-flex">
                                    ...
                                    <div>
                                        ...
                                        <div class="d-flex gap-2">
                                            ...
                                            <button type="button" class="btn btn-sm btn-danger" id="reportBtn" data-bs-toggle="modal" data-bs-target="#reportModal">
                                                <i class="fa fa-exclamation-circle"></i> Report
                                            </button>
                                            <a href="${pageContext.request.contextPath}/MessageServlet?action=getMessages&receiverID=${landlord.userId}" class="btn btn-sm btn-danger" id="reportBtn">
                                                <i class="fa fa-exclamation-circle"></i> Report
                                            </a>
                                        </div>
                                        <!-- Report Modal -->
