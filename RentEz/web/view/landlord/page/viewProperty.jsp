                                        ...
                                        <tbody>
                                            <c:forEach var="property" items="${properties}">
                                                <tr class="property-row" 
                                                    ...
                                                    <td>
                                                        <c:choose>
                                                            <c:when test="${property.availabilityStatus eq 'Available' && property.publicStatus eq true}">
                                                                <span class="property-status status-available">
                                                                    <i class="fas fa-check-circle"></i>
                                                                    Còn trống
                                                                </span>
                                                            </c:when>
                                                            <c:when test="${property.availabilityStatus eq 'Rented' && property.publicStatus eq true}">
