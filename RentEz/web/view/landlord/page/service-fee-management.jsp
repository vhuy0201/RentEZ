...
<body class="bg-gradient-to-br from-gray-50 to-gray-100 min-h-screen">
    ...
    <div id="feeCategoryModal" class="fixed inset-0 bg-black bg-opacity-50 hidden overflow-y-auto h-full w-full z-50">
        <div class="relative top-20 mx-auto p-5 border w-[500px] shadow-lg rounded-xl bg-white">
            <div class="mt-3">
                ...
                <form method="post" action="${pageContext.request.contextPath}/landlord/page/service-fee-action" id="feeCategoryForm">
        ...
        <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-xl bg-white">
            <div class="mt-3 text-center">
                ...
                <div class="flex justify-center space-x-3">
                    ...
                    <form method="post" action="${pageContext.request.contextPath}/landlord/page/service-fee-action" class="inline">
    ...
    <script>
        ...
        function openEditModal(categoryId) {
            ...
            fetch('${pageContext.request.contextPath}/landlord/page/service-fees?action=get&categoryId=' + categoryId)
                .then(response => {
                    if (!response.ok) {
